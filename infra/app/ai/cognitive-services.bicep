...
// Required for using Azure AI Foundry Agent Service (Standard Agents)
resource aiFoundryProject 'Microsoft.CognitiveServices/accounts/projects@2025-06-01' = {
  parent: aiServices
  name: 'voiceAgentProject'
  location: location
  tags: tags
  identity: {
    type: 'SystemAssigned'
  ...
  properties: {
    displayName: 'Voice Agent Project'
    description: 'AI Foundry project for Voice Live Agent'
  }
}
